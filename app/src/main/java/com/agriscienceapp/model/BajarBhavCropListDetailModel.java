...
public class BajarBhavCropListDetailModel {
     ...
     *     The YardCropMapId
     */
    public int getYardCropMapId() {
        return YardCropMapId;
    }
     ...
     *     The YardCropMapId
     */
    public void setYardCropMapId(int YardCropMapId) {
        this.YardCropMapId = YardCropMapId;
    }
